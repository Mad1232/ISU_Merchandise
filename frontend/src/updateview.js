    ...
    return (
        <div>
            ...
            <div>
                ...
                {person === null && fullName && <p style={{ color: 'red' }}>Person not found. Please enter the full name.</p>} {/* Person state is null(no data for that person was found), use of && as will only check other conditions and execute if previous ones are true  */}
            </div>
