...
export function CheckoutView({ cart, navigateToHome, updateCart }) {
    ...
    useEffect(() => {
        // Combine all items from different categories into a single cart
        const combinedCartItems = cart.reduce((accumulator, currentValue) => accumulator.concat(currentValue), []);
